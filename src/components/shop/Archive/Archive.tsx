...
export const Archive: FC<ArchivePropsType> = (props) => {
    ...
    const parentCategoryId = currentCategory?.parent_id ? currentCategory.parent_id : currentCategory?.id;
    ...
    const subcategoriesLinks = transformSubcategoriesIntoLinks(subcategories || [], parentCategorySlug, currentCategory?.id);
    ...
    return (
        <CatalogContainer>
            <CatalogTitleWrapper>
                ...
                <Title as='h1' uppercase>{currentCategory?.name}</Title>
            </CatalogTitleWrapper>
            <CatalogLayout>
                <CatalogFilterBlock>
                    {Boolean(subcategoriesLinks?.length) &&
                        <>
                            <Title as='h3' uppercase textalign="left" marginBottom="24px">Categories</Title>
                            <SideList
