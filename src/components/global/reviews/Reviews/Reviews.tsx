...
import { CustomSwiper, ReviewsContainer, StyledText, TitleBlock } from "./styles";
...
const Reviews: FC<ReviewsPropsType> = ({ product }) => {
    ...
    const reviews: ProductReviewType[] | undefined = data?.data?.items || tempReviews;
...
const tempReviews = [
    ...
    "reviewer": "John Doe",
    "reviewer_email": "john.doe@example.com",
    "review": "Lorem ipsum dolor sit, amet consectetur adipisicing eamet excepturi molestias officiis ducimus, veritatis accusamus nisi dolorem cupiditate. Corrupti dolores a aperiam cumque ea fugit cupiditate, quae id quod, ducimus molestias harum, doloribus repellat quos sapiente ratione modi.",
    "rating": 3,
    "verified": false,
    "reviewer_avatar_urls": {
        "24": "https://secure.gravatar.com/avatar/8eb1b522f60d11fa897de1dc6351b7e8?s=24&d=mm&r=g",
