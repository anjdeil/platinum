...
import {
  ...
  ShippingMethodSelectorMethodDescription,
  ...
  ShippingMethodSelectorValidNotification,
} from './style';

const inpostMethodsIds = [
...
export default function ShippingMethodSelector({
  ...
  const isParcelMachineCollapsed = (methodId: string) => {
    return (
      currentMethodId === methodId && parcelMachinesMethods.includes(methodId)
    );
  };
