...
import { SwiperProps, SwiperType } from '@/types/components/global/sliders/productSwiper';
...
const useProductSwiper = ({ data }: SwiperProps) => {
    ...
    const updateSwiperState = useCallback((images: SwiperType[], slideNumber: number) => {
